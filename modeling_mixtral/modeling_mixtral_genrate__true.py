...
class MixtralSparseMoeBlock(nn.Module):
    ...
    def __init__(self, config, layer_idx=None, all_layers=None):
        ...
        self._all_layers = all_layers #pilou_modif
        self.layer_idx = layer_idx #pilou_modif
...
class MixtralDecoderLayer(nn.Module):
    def __init__(self, config: MixtralConfig, layer_idx: int):
        ...
        self.block_sparse_moe = MixtralSparseMoeBlock(config, all_layers=None, layer_idx=layer_idx)
...
class MixtralModel(MixtralPreTrainedModel):
    def __init__(self, config: MixtralConfig):
        ...
        # 3. Passe la liste complète à chaque bloc sparse
        for layer in self.layers:
            object.__setattr__(layer.block_sparse_moe, "_all_layers", self.layers)
